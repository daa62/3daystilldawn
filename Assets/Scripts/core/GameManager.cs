...
public class GameManager : MonoBehaviour
{
    ...
    public const string FLAG_HAS_FIRE_AXE    = "has_fire_axe";         // found the fire axe
    public const string FLAG_PATH_CLEARED    = "path_cleared";         // smashed the blocked pathway open
